...
const RelatedOutfit = ({currentProductId, changeCurrentProduct}) => {
  return (
    <div id='relatedWidget'>
      <ItemsList list='related' currentProductId={currentProductId} changeCurrentProduct={changeCurrentProduct}/>
